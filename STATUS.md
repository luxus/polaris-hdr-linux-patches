...
| Item | State |
|------|--------|
| **Polaris pin** | **luxus/polaris** `e7ce209` (`feat/linux-stream-runtime` — stream_path registry + runtimes). Not papi-ux `ba166ef`. Local: `POLARIS_SRC=$HOME/projects/polaris nix build --impure .#polaris-stream` |
